    ...
    int inicia_c2(Player *P, Item I, Item J, Item K, int dado){
        int b = 1;
        int acao;
        int aux;
        printf("\n\n - Certo, creio que voce tenha entendido a dinamica de decisoes, entao a partir de agora irei narrar de forma mais direta.");
        printf("\n [...]");
        printf("\n ''Seguindo pelo corredor quente, em determinado ponto voce se deparou com 3 ossadas no chao. Todas eram de homens, na faixa dos 30-40 anos, mas cada um estava segurando algo diferente, ou melhor dizendo, uma arma diferente. Um estava segurando uma espada vermelha, outro um arco com uma flecha verde, e o terceiro um grimorio azul (livro magico).'' ");
        ...
        do{
            ...
            switch(acao){
                case 1:
                    printf("\n ''Apos alguns segundos, voce chegou ate o salao no final do corredor, percebendo que havia um esqueleto vivo no centro dele, protegendo um belo bau de tesouros. O local eh circular e possui um raio de aproximadamente 25 metros, contendo duas portas de saida.'' ");
                    break;
                case 2:
        ...
        printf("\n ''Felizmente, o esqueleto esta de costas para voce, e ainda nao percebeu sua presenca, pois esta fixamente olhando para o bau do salao.'' ");
        printf("\n 1) Avanco contra o esqueleto e utilizo a arma/punhos para tentar atingi-lo por tras, mirando em sua cabeca.");
        printf("\n 2) Avanco contra o esqueleto realizando uma voadora mirada em suas costas.");
        do{
            printf("\n- Acao: ");
            scanf("%d",&acao);
            switch(acao){
                case 1:
                    if(aux==1){
                        printf("\n ''Voce acertou sua espada na cabeca do esqueleto, e eis que imediatamente o corpo dele comecou a ser consumido por chamas que foram invocadas atraves do fio de sua arma. Agora voce sabe que atingir oponentes com ela faz eles serem incendiados. O esqueleto foi consumido ate virar cinzas, mas um pequeno objeto que estava no corpo dele sobreviveu ao incendio, caindo no chao. Este objeto era uma chave.'' ");
                    }
                    else if(aux==2){
                        printf("\n ''Voce acertou a flecha de seu arco na cabeca do esqueleto, e eis que imediatamente brotou uma planta carnivora saindo do corpo dele e o consumiu por completo. Apos isso, a planta adentrou no solo e desapareceu. Agora voce sabe que atingir oponentes com a flecha do arco faz eles serem devorados. Apesar do esqueleto ter sido inteiramente comido, voce percebeu que um pequeno objeto havia caido do corpo dele, atingindo o chao. Este objeto era uma chave.'' ");
                    }
                    else if(aux==3){
                        printf("\n ''Voce conseguiu fazer o grimorio disparar um raio na cabeca do esqueleto, e eis que imediatamente o corpo dele foi eletrocutado por completo, o fazendo cair no chao imovel. Agora voce sabe que mirar em alvos com este item faz ele invocar seu poder eletrico. Com a queda do esqueleto, voce percebeu que um pequeno objeto havia saido do corpo dele, atingindo o chao. Este objeto era uma chave.'' ");
                    }
                    else{
                        printf("\n ''Voce atingiu o esqueleto em cheio, mas ele nao sofreu danos, e ainda se virou velozmente para te atacar, conseguindo quebrar seu pescoco e te matar. Isso nao teria acontecido se voce tivesse usado uma arma.'' ");
                        P->hp=0;
                        b = 0;
                        return b;
                    }
                    break;
                case 2:
                    printf("\n ''Voce atingiu o esqueleto com a voadora, mas ele era tao resistente que nem foi empurrado, inves disso virou em sua direcao em alta velocidade e quebrou seu pescoco, te matando. Isso nao teria acontecido se voce tivesse usado uma arma.'' ");
                    P->hp=0;
                    b = 0;
                    return b;
                default:
        ...
        do{
            ...
            scanf("%d",&acao);
                if(acao==dado){
                    ...
                    printf("\n ''Voce observou que a bomba possui 3 fios: um vermelho, um verde e um azul. Havia o simbolo da cabeca de um esqueleto impresso nessa bomba, talvez isso seja uma pista que indique qual fio eh o correto para se cortar, ou seja, o que permitira a abertura da porta de forma segura.'' ");
